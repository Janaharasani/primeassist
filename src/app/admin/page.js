...
export default function Admin() {
  ...
  const getPaymentBadge = (method) => {
    const methodClasses = {
      cash: 'bg-gray-300 text-gray-800',
  ...
  return (
    <div className="bg-[#000F2B] min-h-screen p-4 sm:p-6 text-white">
      <div className="w-[97%] mt-16 mx-auto">
        <div className="flex flex-col justify-between mb-6 gap-4">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-white sm:text-4xl">
              ...
              <p className="mt-3 text-xs  sm:text-base w-[80%] sm:w-[60%] text-gray-300  mx-auto">
        ...
        {/* Filters */}
        <div className="bg-[#0A1A3F] rounded-xl shadow-md overflow-hidden mb-6 border border-[#1E3A8A]">
         <div className="p-4 border-b border-[#1E3A8A] grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-3 py-2 text-sm border border-[#1E3A8A] rounded-md leading-5 bg-[#122752] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div className="relative">
              ...
              <select
               className="block w-full pl-10 pr-3 py-2 text-sm border border-[#1E3A8A] rounded-md leading-5 bg-[#122752] text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                value={statusFilter}
          ...
          <div className="overflow-x-auto">
            ...
            <thead className="bg-[#122752]">
              ...
              <tbody className="bg-[#0A1A3F] divide-y divide-[#1E3A8A]">
                {loading ? (
                  <tr>
                    <td colSpan={5} className="px-4 sm:px-6 py-4 text-center">
                      <div className="flex justify-center">
                        <FaSync className="animate-spin text-2xl text-blue-300" />
                      </div>
                    </td>
                  </tr>
                ) : filteredBookings.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-4 sm:px-6 py-4 text-center text-gray-400">
                      No bookings found matching your criteria
                    </td>
                  </tr>
                ) : (
                  filteredBookings.map((booking) => (
                    <tr key={booking.id} className="hover:bg-[#122752]">
                        ...
                        <>
                          ...
                          <td className="px-4 sm:px-6 py-4">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                <div className="text-sm font-medium text-gray-300">{booking.name}</div>
